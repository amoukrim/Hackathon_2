...
def generate_text(prompt):
    ...
    output = generator(prompt, max_length=100, do_sample=True, top_k=50)[0]["generated_text"]
    return output
...
if st.button("Générer"):
    with st.spinner("Génération en cours..."):
        ...
        st.session_state.stats["rejected"] += int(!passes_filters)
...
# === README & Choix techniques ===
# 📁 Structure standardisée pour scalabilité
# 📌 Technologies choisies :
# - Streamlit : interface rapide pour prototypage web
# - Transformers (Hugging Face) : NLP moderne, modèles pré-entraînés
# - Datasets (Hugging Face) : accès direct aux données publiques (IMDb)
# - Evaluate : nouvelle lib pour calculs de metrics
# - Plotly : visualisation interactive
# - PyTorch : fine-tuning léger et metrics
# ✅ Convient à un usage CPU / sans GPU
