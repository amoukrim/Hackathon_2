...
def generate_text(prompt):
    ...
    output = generator(prompt, max_length=50, do_sample=True, top_k=50)[0]["generated_text"]
    return output
...
PROMPTS_FILE = "saved_prompts.pkl"
...
if old_prompts:
    st.sidebar.subheader("📜 Prompts précédents")
    for p in old_prompts[-10:][::-1]:
